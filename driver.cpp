    ...
    while (menu_selection != "8") // until user chooses option 6
    {
        ...
        if (menu_selection == "1")
        {
            ...
            else // now come out to your family!
            {
                ...
                ofstream file("coming_out.txt"); // create variable for writing to "coming_out.txt" file
                ...
                if (file.is_open()) // if file opens, execute algorithm
                {
                    ...
                    while (getline(cin, user_letter), user_letter != "eom")
                    {
                        // get user input including spaces and lines
                        file << user_letter; // write to file
                    }
                }
